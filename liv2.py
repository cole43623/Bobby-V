...
def init_map2(game):
    ...
    game.player_pos[1] = 15 * TILE_SIZE
    game.y_velocity = 0
    game.jumping = 0
    game.jolly[0] = 0
    game.jolly[1] = 0
...
aaaaaaaaaaaaaaaaadhJEJedaaaaaaaaaaaaaaaa
aaaaaaaaaaaaaaaakJJJJJJJgaaaaaaaaaaaaaaa
aaaaaaaaaaaaaaaaalccJcclaaaaaaaaaaaaaaaa
aaaaaaaaaaaaaaaaakCCTCCgaaaaaaaaaaaaaaaa
aaaaaaaaaaaaaaaaakCCTCCgaaaaaaaaaaaaaaaa
aaaaaaaaaaaaaaaaakCCTCCgaaaaaaaaaaaaaaaa
